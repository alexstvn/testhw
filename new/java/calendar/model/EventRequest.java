...
public class EventRequest {
  ...
  public static class RequestBuilder {
    ...
    /**
     * Generates a copy of the event request by copying in the fields.
     *
     * @param eventRequest Event Request object that represents data to pass into model.
     * @return Updated builder object to initialize event request.
     */
    public RequestBuilder copy(EventRequest eventRequest) {
      subject = eventRequest.getSubject();
      start = eventRequest.getStart();
      end = eventRequest.getEnd();

      property = eventRequest.getProperty();
      newValue = eventRequest.getNewValue();

      pattern = eventRequest.getPattern();
      termination = eventRequest.getTermination();
